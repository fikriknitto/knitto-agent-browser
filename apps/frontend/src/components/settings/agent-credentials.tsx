...
import { Button, Card, CardTitle, Input, Select } from "@/components/chat/ui";
  ...
  return (
    <Card>
      ...
      <p className={`${hint} mb-3`}>
        Cursor memakai API key. OpenAI-compatible memakai Base URL + key (preset lokal mengisi Base
        URL di localhost:20128).
      </p>
      {form}
    </Card>
  );
