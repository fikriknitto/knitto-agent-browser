import { DEFAULT_CHANNEL, DEFAULT_WS_HOST, DEFAULT_WS_PORT } from "@/lib/utils/protocol";
import type { ConnectionState } from "@/types/automation";
import { btnRow, fieldRow, hint, statusLine } from "@/lib/utils/ui";
import { SettingsRow, SettingsSectionTitle } from "./settings-row";
import { Badge, Button, Card, CardTitle, Input, Label } from "@/components/chat/ui";
  ...
  return (
    <Card>
      ...
      <p className={statusLine}>
        Socket: <Badge variant={connected ? "success" : "default"}>{connectionState}</Badge>
        Agent:{" "}
        <Badge variant={bridgeAvailable ? "success" : "default"}>
      ...
      {bridgeAvailable && typeof browserHeaded === "boolean" && (
        <p className={statusLine}>
          ...
          <br />
          <span className={hint}>
            Set AUTOMATION_HEADLESS=false on the agent worker for headed mode.
          </span>
        </p>
      )}
    </Card>
