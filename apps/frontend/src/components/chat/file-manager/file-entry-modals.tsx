...
const nestedModalShell =
  "relative z-[1] w-[min(92vw,420px)] overflow-hidden rounded-[14px] border border-black/10 bg-white shadow-[0_24px_80px_rgba(0,0,0,0.2)] dark:border-white/10 dark:bg-[rgba(12,14,22,0.98)] dark:shadow-[0_24px_80px_rgba(0,0,0,0.45)]";

const closeBtnClass =
  "border-0 bg-transparent text-black-40 hover:bg-black/5 hover:text-black-100 dark:text-slate-300 dark:hover:bg-slate-600/85 dark:hover:text-slate-50";
  ...
  return createPortal(
    <div className="fixed inset-0 z-[10002] flex items-center justify-center p-4" role="presentation">
      ...
      >
        ...
        >
          <Label className="grid gap-2 text-sm text-black-80 dark:text-slate-300">
            Nama baru
            <Input
              type="text"
              value={name}
    ...
    <div className="fixed inset-0 z-[10002] flex items-center justify-center p-4" role="presentation">
      ...
      >
        ...
        <div className="flex flex-col gap-4 px-5 py-4">
          ...
          {affectsAttachments && (
            <p className="m-0 text-sm leading-relaxed text-amber-700 dark:text-amber-400/90">
