...
import { Button, Input, Label, Select } from "@/components/chat/ui";
      ...
      <div className="flex flex-wrap items-center justify-end gap-2.5">
        ...
        <div className="flex gap-1.5" role="group" aria-label="Tampilan">
          <Button
            ...
            className={
              viewMode === "grid"
                ? "border border-blue-500/40 bg-blue-500/10 text-blue-700 dark:border-blue-400/45 dark:bg-blue-500/22 dark:text-blue-200"
                : undefined
            }
