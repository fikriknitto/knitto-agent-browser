/** Layout & modal utility class strings (non-primitive UI). */

export const fieldRow = "mb-3.5 grid gap-3.5";

export const btnRow = "flex flex-wrap gap-2.5";

export const hint = "text-xs leading-snug text-slate-500";

export const statusLine = "mt-3 flex flex-wrap items-center gap-2 text-sm text-slate-400";

export const statusMessage = "text-xs font-medium text-sky-400";
